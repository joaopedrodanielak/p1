...
router.patch('/editar/:id', async(req,res)=>{
    try {
        const updatedCliente = await CadastroCliente.updateOne({_id: req.params.id},{$set:
            { nome :req.body.nome,sobrenome : req.body.sobrenome,cpf : req.body.cpf,rg:req.body.rg,data_de_nascimento : req.body.data_de_nascimento,
                endereco : req.body.endereco,cidade : req.body.cidade,telefone : req.body.telefone,email : req.body.email}})
